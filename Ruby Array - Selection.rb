...
This code contains four different methods (`select_arr`, `reject_arr`, `delete_arr`, `keep_arr`) that perform operations on an array `arr` based on certain conditions.
